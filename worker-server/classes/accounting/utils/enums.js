module.exports = {
    ...
    EVENT_CATEGORY: {
        CHARGES: 'Charges',
        PREPAID_LIABILITY: 'Prepaid Liability',
        PAYMENTS: 'Payments',
        LIABILITY_RECOGNITION: 'Liability Recognition',
        REFUNDS: 'Refunds',
        BAD_DEBT: 'Bad Debt',
    ...
    EXPORT_FORMATS: {
        YARDI_FINANCIAL_JOURNAL: 'yardifinancialjournal',
        YARDI_FINANCIAL_JOURNAL_IPP : 'yardi-financial-journal-ipp'
    },
    NOTES: {
