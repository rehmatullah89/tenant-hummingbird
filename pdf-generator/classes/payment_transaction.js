...
class PaymentTransaction {
    ...
    constructor(data) {
      ...
      setConfig(){
        ...
        let paymentTransactions = this.data.data;
        ...
        columns: [
          {
            key: 'transactiondateproperty',
            name:'Transaction Date (Property)',
            type: 'string',
            width: 20
          },
          {
          ...
          {
            key: 'transactiondatepsp',
            name: 'Transaction Date (PSP)',
            type: 'string',
            width: 20
          },
          {
            key: 'hummingbirdtransactionid',
            name: 'HB Transaction ID',
            type: 'string',
            width: 20
          },
          {
            key: 'psptransactionid',
            name: 'PSP Transaction ID',
            type: 'string',
            width: 40
          },
          {
          ...
          {
            key: 'payoutidpsp',
            name: 'Payout Transaction ID (PSP)',
            type: 'string',
            width: 15
          },
          {
            key: 'payoutinitiatedatepsp',
      ...
      async printHeader(cxt, pdfWriter, leftOffset, topOffset, mediumTextOptions, boldTextOptions) {
        ...
        await cxt.writeText('Payment Transaction Report', leftOffset, topOffset, boldTextOptions);
