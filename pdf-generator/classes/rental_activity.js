...
class RentalActivity {
  ...
  setConfig(){
    ...
    this.config.push({
      ...
      rows: this.data.data.rentalActivityMoveIn
    });
    ...
    this.config.push({
      ...
      rows: this.data.data.rentalActivityMoveOut
    });
  ...
  async generate(socket){
    ...
    let data_length = this.data.data.rentalActivityMoveIn && this.data.data.rentalActivityMoveIn.length ? this.data.data.rentalActivityMoveIn.length : 0;
    data_length += this.data.data.rentalActivityMoveOut && this.data.data.rentalActivityMoveOut.length ? this.data.data.rentalActivityMoveOut.length : 0;
  ...
  async printHeader(cxt, pdfWriter, leftOffset, topOffset, mediumTextOptions, boldTextOptions) {
    ...
    await cxt.writeText('Move-in/ Move-out Activity', leftOffset, topOffset, boldTextOptions);
  ...
  async PrintNetSummary(cxt, leftOffset, topOffset, mediumTextOptions) {
    ...
    mediumTextOptions.size = 9;
    let str =  `Total Move In's: ${this.data.data.rentalActivityMoveIn.length}`;
    ...
    mediumTextOptions.size = 9;
    str =  `Total Move Out's: ${this.data.data.rentalActivityMoveOut.length}`;
    ...
    mediumTextOptions.size = 9;
    str =  `Net: ${this.data.data.rentalActivityMoveIn.length - this.data.data.rentalActivityMoveOut.length}`;
