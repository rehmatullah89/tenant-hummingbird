...
module.exports = {
	...
	findByCompanyId: function(connection, company_id, filters){
		let productSql = "Select * from insurance WHERE product_id in (select id from products where status = 1) and company_id = " + connection.escape(company_id);
