...
module.exports = {
    ...
    findDistinctRoles(connection){
        var sql = "SELECT DISTINCT id FROM roles";
        return connection.queryAsync(sql);
    },

    findCompanyRoles(connection, company_id){
        var sql = `select * from roles where company_id = ${connection.escape(company_id)}`;
        return connection.queryAsync(sql);
    },
