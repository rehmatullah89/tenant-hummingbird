...
const REPORTS = require('./enums/reports.js');
const REVERSAL = require('./enums/reversal.js');
...
module.exports = {
    LEAD_TYPE: {
        "abandoned_rental": "cart_abandonment",
        "coupon": "coupon_clicks",
        "hotlead":  "hotlead",
        "default": "new_web_lead"
    },
    EVENT_TYPES: {
        LEAD: {
    ...
    EVENT_TYPES_COLLECTION: {
            ...
            LEAD: ['new_web_lead', 'lead_follow_up', 'new_lead', 'cart_abandonment', 'coupon_clicks', 'hotlead'],
    ...
    GENERATE_DOCUMENT_REVERSAL_TYPES: {
        ACH: REVERSAL_TYPES.ACH,
        CHARGEBACK: REVERSAL_TYPES.CHARGEBACK,
        NSF: REVERSAL_TYPES.NSF,
    },
    REVERSAL: REVERSAL,
    LOGGING: LOGGING,
    AMENITY_CATEGORY:{
    ...
    SIGNED_DOCUMENT_TYPES: [
        ...
        { name: 'Other (With Signature)', value: 'other' }
    ],
    UPLOAD_DESTINATIONS: {
    ...
    PAYMENT_ERROR:{
        ...
        GATEWAY_MESSAGE: 'An Error has occurred. The transaction was not successful. You can try the transaction again.If the issue persists, please report this to technical support by copying this error text or taking a screenshot.',
        ISSUER_ERROR: 'Issuer Rejection: ',
        ISSUER_MESSAGE: 'The card holders bank has rejected the transaction.More information is below.Try another payment method or have the card holder contact their issuing bank to resolve the issue'
    },
    PAYMENT_METHODS: {
        CASH: 'cash',
        CHECK: 'check',
    ...
    WEB_LEAD_TYPES: {
            "abandoned_rental": "Cart Abandonment",
            "coupon": "Coupon Clicks",
            "hotlead": "Hot Lead",
            "waitlist": "Waitlist",
    },
    ROLES: {
        INTER_PROPERTY_OPERATIONS: 'Inter Property Operations'
    },
    PERMISSIONS: {
        ACCEPT_INTER_PROPERTY_PAYMENT: {
            LABEL: 'accept_inter_prop_payment'
        }
    },
    PAYMENT_CYCLES: {
        MONTHLY: 'Monthly',
