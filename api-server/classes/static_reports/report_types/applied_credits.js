...
class AppliedCreditsReport extends BaseStaticReport{
    constructor(configuration){
        ...
        this.name = "Applied Credits Report";
    }
    ...
    async getData(){
        ...
        let data = await Report.findAppliedCredits(this.connection,this.company.id, this.property_id, this.date, this.end_date);
        this.data = utils.formatData(data, this.getFields(), { set_header: true, set_total: true });
        return this.data;
    }
}

module.exports = AppliedCreditsReport