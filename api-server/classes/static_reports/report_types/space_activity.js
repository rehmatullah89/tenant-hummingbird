...
class SpaceActivityReport extends BaseStaticReport{
    ...
    async getData(){
        ...
        let data = await Report.findSpaceActivities(this.connection, this.company.id, this.property_id, this.date, this.end_date);
        this.data = utils.formatData(data, this.getFields(), { set_header: true, set_total: false });
        return this.data;
    }
}

module.exports = SpaceActivityReport