...
class PaymentProcessingReport extends BaseStaticReport{
    constructor(configuration){
        ...
        this.name = "Payment processing report";
    }
    ...
    async getData(){
        ...
        let data = await Report.paymentProcessing(this.connection,this.company.id, this.property_id, this.date, this.end_date);
        this.data = utils.formatData(data, this.getFields(), { set_header: true, set_total: false });
        return this.data;
    }
}

module.exports = PaymentProcessingReport