...
class raw extends BaseStaticReport{
    constructor(configuration){
        ...
        this.name = "Raw Transaction Report";
    }
    ...
    async getData(){
        ...
        let data = await Report.raw(this.connection,this.company.id, this.property_id, this.date, this.end_date);
