...
class PaymentByProductTypeReport extends BaseStaticReport{
    ...
    async getData(){
        ...
        let data = await Report.findPaymentByProductType(this.connection, this.property_id, this.date, this.end_date)
...
module.exports = PaymentByProductTypeReport