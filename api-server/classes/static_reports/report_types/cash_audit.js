...
class CashAuditReport extends BaseStaticReport{
    ...
    async getData(){
        ...
        let data = await Report.getCashAudit(this.connection, this.property_id, this.date, this.end_date);
        this.data = utils.formatData(data, this.getFields(), { set_header: true, set_total: true });
        return this.data;
    }
}

module.exports = CashAuditReport