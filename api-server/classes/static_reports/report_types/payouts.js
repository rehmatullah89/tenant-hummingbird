...
class Payouts extends BaseStaticReport {
    ...
    async getData() {
        ...
        let data = await Report.payouts(this.connection,this.company.id, this.property_id, this.date, this.end_date);
