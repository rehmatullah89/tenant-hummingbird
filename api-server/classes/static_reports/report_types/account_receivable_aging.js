...
class AccountReceivableAgingReport extends BaseStaticReport {
    ...
    async getData(){
        ...
        let data = await Report.findPastDueAging(this.connection,this.company.id, this.property_id, this.date);
        this.data = utils.formatData(data, this.getFields(), { set_header: true, set_total: true });
        return this.data;
    }
}

module.exports = AccountReceivableAgingReport